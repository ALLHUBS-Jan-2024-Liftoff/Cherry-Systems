-- sample users
INSERT INTO Users (username, pwHash, email) VALUES
...
-- sample submissions
INSERT INTO Submissions (user_id, location_name, location_address, Place_id, rating, description, submission_review)
VALUES
...
-- sample reviews
INSERT INTO Reviews (submission_id, user_id, rating, review)
VALUES
...
-- sample review votes
INSERT INTO ReviewVotes (review_id, user_id, vote_type)
VALUES
(1, 1, 'up'),
(2, 3, 'down'),
(3, 2, 'up');
...
INSERT INTO SubmissionVotes (submission_id, user_id, vote_type)
VALUES
(1, 1, 'up'),
(2, 3, 'down'),
(3, 2, 'down');